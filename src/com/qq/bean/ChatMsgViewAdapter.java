...
public class ChatMsgViewAdapter extends BaseAdapter {
	...
	public View getView(int position, View converView, ViewGroup parent) {
		...
		if (converView == null) {
			...
			viewHolder.Userhead = (ImageView) converView.findViewById(R.id.iv_userhead);
		...
		viewHolder.tvSendtime.setText(entity.getSendDate());
		//viewHolder.Userhead.setImageResource(entity.getHeadImg());
		return converView;
	}
